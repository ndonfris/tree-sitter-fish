...
module.exports = grammar({
    ...
    rules: {
        ...
        _base_expression: $ => choice($.command_substitution, $.single_quote_string, $.double_quote_string, $.variable_expansion, $.word, $.integer, $.float, $.brace_expansion, seq($.escape_sequence, repeat1(alias($._line_continuation_comment, $.comment))), $.escape_sequence, $.glob, $.home_dir_expansion),
